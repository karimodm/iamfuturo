...
# {"method":"SUBSCRIBE","params":["!miniTicker@arr","btcusd_210625@aggSnap","btcusd_210625@markPrice","btcusd@indexPrice","!markPriceMini@arr","btcusd_210625@depth@500ms","!contractInfo","btcusd_current_quarter@continuousKline_1d"],"id":1}
bfm.start_futures_symbol_markprice_socket('btcusd_210625',process_message,update_time=1)
